// ==========================================
// Qué hace: Insignia atómica del icono de la métrica con fondo translúcido y micro-animación hover.
...
/// Icono estilizado con resplandor reactivo
class AiMetricIcon extends StatelessWidget {
  const AiMetricIcon({
